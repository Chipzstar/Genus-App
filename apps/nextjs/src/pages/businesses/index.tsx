				...
				<div className="mx-auto w-full max-w-3xl">
					<nav className="flex grow items-center justify-between">
						<section className="flex items-center space-x-4">
							<BackButton />
							<header className="text-2xl font-bold text-black sm:text-4xl">Business Directory</header>
						</section>
						<Link href={PATHS.CREATE_BUSINESS}>
							<span className="text-2xl font-bold text-primary underline">Create Post</span>
						</Link>
					</nav>
					<SearchFilterPanel
						value={search}
